...
public class readMeScript {
	...
	public static void Main(string[] args) {
		...
		outputFile.WriteLine("This repository contains my attempt at solving programming problems I find on HackerRank. Below is a table that contains the problem name, the status of the problem, where the problem was found and what language(s) it is completed in.\n");
